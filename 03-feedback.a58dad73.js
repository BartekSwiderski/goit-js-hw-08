...
"use strict";var e=t(require("../../node_modules/lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a=document.querySelector(".feedback-form");function l(e){e.preventDefault();const{elements:{email:t,message:a}}=e.currentTarget;let l={email:`${t.value}`,message:`${a.value}`};localStorage.setItem("feedback-form-state",JSON.stringify(l))}a.addEventListener("input",(0,e.default)(l,500));const s=localStorage.getItem("feedback-form-state");try{let e=JSON.parse(s);a.email.value=e.email,a.message.value=e.message}catch(n){console.log(`Błąd ${n.name}`)}function r(e){e.preventDefault();const{elements:{email:t,message:a}}=e.currentTarget;let l={email:`${t.value}`,message:`${a.value}`};console.log(l),localStorage.clear(),e.currentTarget.reset()}a.addEventListener("submit",r);
},{"../../node_modules/lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.a58dad73.js.map